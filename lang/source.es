...
|S¢lo puedes hacer login
|veces al mismo tiempo
|Otro usuario est  usando esa door, int‚ntalo m s tarde.
SN| Es correcto [s/N]: 
|No puedo iterpretar
...
|Teclea tu n£mero de tel‚fono de MODEM
|¨Donde vives? (Ciudad): 
...
12|Elige: 1) Editor de lineas, 2) E. Pantalla completa, 3) Editor externo 
|¡No hay mensajes! 
...
|Nov
|Dic
|Autodesconeccion: ¨Te has dormido o es que se ha cortado?
|se empaquetar n.
...
1|Elige: 1) Editor de lineas, 2) Editor de pantalla completa
